...
def parse_arguments():
    ...
    parser.add_argument('--h_dim', default=512, type=int, help='dimensionality of hidden embedding')
    parser.add_argument('--out_dim', default=256, type=int, help='dimensionality of output embedding')
    ...
    parser.add_argument('--seed', default=2024, type=int, help='global random seed for reproduction')
    parser.add_argument('--batch_size', default=15000, type=int, help='batch size for graph sampler')
    parser.add_argument('--num_layers', default=8, type=int, help='Number of Conv layers in the GNN')
